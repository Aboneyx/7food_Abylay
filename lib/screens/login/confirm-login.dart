...
class ConfirmLoginScreen extends StatelessWidget {
  ...
  const   ConfirmLoginScreen({Key? key, required this.phone, required this.page})
      : super(key: key);
                  ...
                  SizedBox(
                    ...
                    child: TextButton(
                      onPressed: () async {
                        ...
                        final user = await _authService.loginWithVerificationCode(phoneToBack, _verificationCode, context);
                        print(user);
                        if(user != null) {
                          Navigator.pushAndRemoveUntil(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => PinCodeScreen(id: 'login',)),
                                  (route) => false
                          );
                        }
                      },
